...
class JsonInteropSpec extends ScalaIntegrationTest {
  ...
  case class User(name: String, age: Int, addresses: Seq[Address]) derives AsObject
  ...
  object User2 {
    implicit val decoder: circe.Decoder[User2] =
      circe.Decoder.forProduct3("name", "age", "addresses")(User2.apply)
    implicit val encoder: circe.Encoder[User2] =
      circe.Encoder.forProduct3("name", "age", "addresses")(x => (x.n, x.a, x.s))
